...
class GGoogleMapsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        botonCarolina.setOnClickListener { irCarolina() }
    }
    ...
    fun solicitarPermisos(){
        ...
        val permisosFineLocation = ContextCompat.checkSelfPermission(
            contexto,
            permisoFineLocation //Este permiso se va a checkear
        )
        ...
        if (tienePermisos){
            ...
            ActivityCompat.requestPermissions(
                this, //Contexto
                arrayOf(permisoFineLocation, permisoCoarse), //Arreglos de permisos
    ...
    fun moverQuicentro(){
        val zoom = 17f
        val quicentro = LatLng(-0.1825684318486696, -78.48447277600916)
